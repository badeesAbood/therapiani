...
class $AssetsAnimationsGen {
  ...
  /// File path: assets/animations/charts.json
  LottieGenImage get charts =>
      const LottieGenImage('assets/animations/charts.json');

  /// File path: assets/animations/meds_inventory.json
  LottieGenImage get medsInventory =>
      const LottieGenImage('assets/animations/meds_inventory.json');

  /// File path: assets/animations/notifications.json
  ...
  List<LottieGenImage> get values =>
      [charts, medsInventory, notifications, treatAdd];
}
